...
```json
{
    ...
    "content": "Look at the great sandals I picked up in Milan! They make my feet look really great… https://domain.com/image.jpg",
    "id": "<event-id>"
}
```
...
Question: Kind 1984 is not replaceable. Should it be ditched for something that is replaceable so people can update labeling they previously assigned?
...
"id": "<event-id>"
    ...
    "tags": [
      ["t", "hastag"],
      ["content-warning", "", "PN-trn,PG-picture,PN-trn-website,NS-ero-banner"]
    ],
...
```json
{
  "kind": 1984,
  "tags": [
    [ "p", <pubkey>, "PN-trn,PG-picture,PN-trn-website,NS-ero-banner"]
  ],
